...
\begin{figure}[H]
  \centering
  \fbox{\begin{minipage}{0.75\textwidth}\centering\vspace{3.2cm}
    {\color{cmuGray}\itshape
      [Insert photo: working system — LCD showing ``Enter: 90\_ '' / ``Set: 90 deg'',
       servo positioned at 90°, keypad and Nucleo board visible]}
